...
.brand{display:inline-flex;flex-direction:column;text-decoration:none;position:relative;padding-top:46px;padding-bottom:4px;color:inherit}
.brand-name{font:2.35rem/1 Georgia,serif;color:var(--ink);letter-spacing:-.035em;display:inline-flex;align-items:baseline}
...
.brand-tag{display:block;font:9.5px Arial,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:#8b682b;margin-top:4px;font-weight:700}
.k-falcon-anchor{position:relative;display:inline-block}
.k-falcon-img{position:absolute;bottom:85%;left:36%;transform:translateX(-50%);width:62px;height:auto;filter:drop-shadow(0 2px 6px rgba(188,148,79,.6));pointer-events:none;transition:transform .3s ease}
.brand:hover .k-falcon-img{transform:translateX(-50%) translateY(-3px) scale(1.06)}
...
@media(max-width:560px){
  ...
  .brand{padding-top:34px;padding-bottom:4px}
  .brand-name{font-size:1.65rem}
  .brand-tag{font-size:7.5px;letter-spacing:.18em}
  .k-falcon-img{width:46px;bottom:85%;left:36%}
  .header-nav{gap:8px}
  ...
  <div class="wrap header-row">
    <a class="brand" href="index.html">
      <span class="brand-name">
        <span class="k-falcon-anchor">
          <img class="k-falcon-img" src="kotwari_eagle_transparent.png" alt="Kotwari Golden Falcon">
          K
        </span>otwari<sup>&trade;</sup>
      </span>
