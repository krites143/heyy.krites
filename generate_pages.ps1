...
.brand-emblem-img{width:46px;height:auto;display:block;margin:0 auto 2px;filter:drop-shadow(0 2px 5px rgba(188,148,79,.35));transition:transform .3s ease}
...
footer .brand .brand-emblem-img{margin:0 0 4px 0}
